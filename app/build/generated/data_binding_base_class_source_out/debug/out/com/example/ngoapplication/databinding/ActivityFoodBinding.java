...
public final class ActivityFoodBinding implements ViewBinding {
  ...
  private ActivityFoodBinding(@NonNull ConstraintLayout rootView, @NonNull Button dntButton,
      ...
      @NonNull TextView textView4, @NonNull TextView textView9, @NonNull TextView tpText) {
    this.rootView = rootView;
    this.dntButton = dntButton;
  ...
  public static ActivityFoodBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.dntButton;
      Button dntButton = ViewBindings.findChildViewById(rootView, id);
      if (dntButton == null) {
        break missingId;
      }
      ...
      id = R.id.tpText;
      TextView tpText = ViewBindings.findChildViewById(rootView, id);
      if (tpText == null) {
        break missingId;
      }

      return new ActivityFoodBinding((ConstraintLayout) rootView, dntButton, foodEditText,
          imageView10, pickDateEditText, pickEditText, pkLocEditText, quantityEditText, textView4,
          textView9, tpText);
    }
